    ...
    AOXCBaseReporter
{
    ...
    function initialize(address admin, address _monitoringHub) external initializer {
        ...
        _performForensicLog(IMonitoringHub.Severity.INFO, "INITIALIZE", "Guardian Registry online", address(0), 0, "");
    }
     ...
     */
    function addGuardian(address guardian) external onlyRole(ADMIN_ROLE) whenNotPaused nonReentrant {
        ...
        _performForensicLog(IMonitoringHub.Severity.INFO, "GUARDIAN_ADDED", "New sentinel authorized", guardian, 10, "");
    ...
    function removeGuardian(address guardian) external onlyRole(ADMIN_ROLE) nonReentrant {
        ...
        _performForensicLog(
            IMonitoringHub.Severity.WARNING, "GUARDIAN_REMOVED", "Sentinel dismissed from registry", guardian, 30, ""
        );
