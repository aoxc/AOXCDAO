...
contract SombreroSentinel is AccessControl, ReentrancyGuard {
    ...
    function _initializeProtocols() internal {
        protocols[SOMBRERO_APEX] = SecurityProtocol({minRank: 6, alertActive: false, incidentCount: 0});
        protocols[SOMBRERO_KINETIC] = SecurityProtocol({minRank: 4, alertActive: false, incidentCount: 0});
        protocols[SOMBRERO_NEURAL] = SecurityProtocol({minRank: 5, alertActive: false, incidentCount: 0});
        protocols[SOMBRERO_AEGIS] = SecurityProtocol({minRank: 4, alertActive: false, incidentCount: 0});
        protocols[SOMBRERO_PULSE] = SecurityProtocol({minRank: 2, alertActive: false, incidentCount: 0});
    }
    ...
    function reportAnomaly(string calldata _threatType, address _suspect) external onlyQualified(SOMBRERO_PULSE) {
