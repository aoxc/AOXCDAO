    ...
    UUPSUpgradeable
{
    ...
    event IdentityUpdated(address indexed account, string oldId, string newId, address indexed verifier);
     ...
     */
    function register(address account, string calldata id) external override onlyRole(VERIFIER_ROLE) whenNotPaused {
    ...
    function _authorizeUpgrade(address) internal override onlyRole(UPGRADER_ROLE) {
        _logToHub(IMonitoringHub.Severity.CRITICAL, "UPGRADE", "Identity Registry upgrade authorized");
    }
