...
contract AOXP is Initializable, ERC1155Upgradeable, AccessControlUpgradeable, UUPSUpgradeable {
     ...
     */
    function awardXp(address to, uint256 amount, string calldata reason) external onlyRole(MINTER_ROLE) {
     ...
     */
    function revokeXp(address from, uint256 amount, string calldata reason) external onlyRole(REVOKER_ROLE) {
