...
contract VirgoFabricator is AccessControl, ReentrancyGuard {
    ...
    constructor(address _aoxcToken, address _reputation, address _monitoring, address _andromeda, address _captain) {
    ...
    function _initializeDepartments() internal {
        departmentRegistry[VIRGO_APEX] =
            Department({rankRequirement: 6, epochQuota: 1_000_000e18, epochSpent: 0, isOperational: true});
        departmentRegistry[VIRGO_KINETIC] =
            Department({rankRequirement: 4, epochQuota: 500_000e18, epochSpent: 0, isOperational: true});
        departmentRegistry[VIRGO_FLUX] =
            Department({rankRequirement: 3, epochQuota: 200_000e18, epochSpent: 0, isOperational: true});
