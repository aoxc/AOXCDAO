    ...
    ReentrancyGuard
{
    ...
    event TokensRedeemed(address indexed caller, address indexed from, uint256 indexed amount, bytes32 assetId);
    event BackingReleased(address indexed caller, bytes32 indexed assetId, uint256 amount, uint256 timestamp);
