...
contract AOXCComplianceEvents is Initializable, AccessControlUpgradeable, ReentrancyGuard {
     ...
     */
    function emitBlacklist(address account, string calldata reason) external nonReentrant onlyRole(COMPLIANCE_ROLE) {
     ...
     */
    function _logToHub(IMonitoringHub.Severity severity, string memory action, string memory details, address related)
        internal
    {
